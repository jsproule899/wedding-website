...
function Home({ guestOne, guestTwo, plusOne, family }: { guestOne: string | null; guestTwo: string | null, plusOne: string | null; family: string | null; }) {
    return (
            <FadeSection id='Home' className='justify-center'>
                ...
                <h2></h2>
                <h2 className='font-minerva text-white text-lg sm:text-4xl mb-1'>Rachael & Josh would like to invite</h2>
                ...
                <p className='font-minerva font-light text-center max-w-10/12 text-md sm:text-2xl'>The Rabbit Hotel, 882 Antrim Rd, Templepatrick, Ballyclare BT39 0AH</p>
                <p className='font-minerva font-light text-center text-md sm:text-2xl'>1:30pm</p>
                <a href="#RSVP" className="cursor-pointer bg-white text-primary px-6 py-0.5 my-6 text-3xl"
                    aria-label="RSVP button">
                    RSVP
                </a>
                <p className='text-lg leading-4'>Reception to follow</p>
            </FadeSection>
    )
}
